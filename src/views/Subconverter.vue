        ...
        <el-card>
          <div slot="header">
            ...
            <svg-icon class="channel" icon-class="telegram" style="float:right;margin-left: 10px"
                      @click="gotoTgChannel"/>
            <div style="text-align:center;font-size:15px">BobVane 订 阅 转 换</div>
          </div>
          <el-container>
...
export default {
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "BobVane自建后端": "https://subapi.bobvane.top",
        ...
        backendOptions: [
          {value: "https://subapi.bobvane.top"},
        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "默认（Bob-crypto）",
                value: "https://raw.githubusercontent.com/bobvane/clash/refs/heads/main/Clash-mini-bob.ini"
              },
              {
                label: "默认（Bob-mini）",
              ...
              {
                label: "默认（Bob-All带虚拟币）",
                value: "https://raw.githubusercontent.com/bobvane/clash/refs/heads/main/Cash-All.ini"
              },
              {
                label: "默认（Bob-Full）",
                value: "https://raw.githubusercontent.com/bobvane/clash/refs/heads/main/Clash-Full.ini"
              }
            ]
          },
          {
      ...
      form: {
        ...
        remoteConfig: "https://raw.githubusercontent.com/bobvane/clash/refs/heads/main/Clash-mini-bob.ini",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert('<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px;color:red">subweb.bobvane.top，BobVane自建订阅工具</span></strong></div>', '信息面板', {
    ...
    getBackendVersion() {
      this.$axios
          ...
          .then(res => {
            ...
            a ? this.$message.success(`${this.backendVersion}` + "肥羊负载均衡增强版后端，已屏蔽免费节点池（会返回403），额外支持vless reality+hysteria+hysteria2订阅转换") : b ? this.$message.success(`${this.backendVersion}` + "本地局域网自建版后端") : this.$message.success(`${this.backendVersion}` + "asdlokj1qpi23版后端支持vless/hysteria订阅转换");
          })
          .catch(() => {
